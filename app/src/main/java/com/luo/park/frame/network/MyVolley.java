...
import com.luo.park.ApiURL;
import com.luo.park.MainApplication;
import com.luo.park.R;
import com.luo.park.utils.DpiUtils;
...
/**
 * Volley网络请求框架，可以处理文件传输以外的大部分网络请求。
 * 另外，可以异步加载图片。
 * Created by TYQ on 2015/1/12.
 */
public class MyVolley {
    ...
    public static void asyncImage(String picUrl, ImageView imageView, int maxWidth, int maxHeight) {
        ...
        MyVolley.getInstance().getImageLoader().get(picUrl, ImageLoader.getImageListener(imageView, R.mipmap.default_image, R.mipmap.default_image), maxWidth, maxHeight);
    }
